        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="p-4 rounded border border-border bg-surface-1 space-y-3">
            <div className="flex items-center justify-between border-b border-border-subtle pb-2">
              ...
              <span className="px-1.5 py-0.5 rounded text-[10px] font-mono uppercase bg-sky-950 text-sky-300 border border-sky-800">
                REVIEW_REQUIRED
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 text-[11px] font-mono">
              ...
              <div className="p-2 rounded bg-surface-2 border border-border-subtle">
                <span className="text-slate-400 block text-[10px]">Method Quality:</span>
                <span className="text-emerald-400 font-semibold">HIGH (±0.6°C)</span>
              </div>
            </div>
          ...
          <div className="p-4 rounded border border-border bg-surface-1 space-y-2">
            ...
            <p className="text-data text-slate-300 bg-surface-2 p-3 rounded border border-border-subtle leading-relaxed">
              {explanation?.summary || anomaly.explanation_summary}
            </p>
            {explanation?.recommended_investigation_steps && (
